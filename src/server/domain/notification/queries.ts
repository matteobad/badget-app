...
export interface Getnotification_settings_tableParams {
  userId: string;
  organizationId: string;
  notificationType?: string;
  channel?: NotificationChannel;
...
export async function getnotification_settings_table(
  db: DBClient,
  params: Getnotification_settings_tableParams,
...
export async function shouldSendNotification(
  ...
  const settings = await getnotification_settings_table(db, {
    userId,
    organizationId,
    notificationType,
    channel,
...
> {
  const userSettings = await getnotification_settings_table(db, {
    userId,
    organizationId,
  });
...
export async function bulkUpdatenotification_settings_table(
  db: DBClient,
  userId: string,
  organizationId: string,
  updates: {
