...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:max-w-fit group-[.is-user]:rounded-2xl group-[.is-user]:rounded-br-none group-[.is-user]:!bg-[#F7F7F7] group-[.is-user]:!px-4 group-[.is-user]:!py-2 group-[.is-user]:!text-primary dark:group-[.is-user]:!bg-[#131313]",
      "group-[.is-assistant]:!rounded-none group-[.is-assistant]:!border-none group-[.is-assistant]:!bg-transparent group-[.is-assistant]:!px-0 group-[.is-assistant]:!py-0 group-[.is-assistant]:!text-[#666666] group-[.is-assistant]:!shadow-none",
      className,
    )}
    {...props}
  >
