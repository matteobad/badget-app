export default {
  ...
  "account.date_and_locale": "Date and locale",
  ...
  widgets: {
    ...
    income: {
      title: "Income",
      description: "{category} makes up {percentage}% of your incomes",
      description_empty: "No income recorded",
