    ...
    <div className="m-auto my-20 max-w-[600px]">
      ...
      <div className="text-component line-height-lg v-space-md">
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB ("us", "we", or "our") operates the Badget application
        ...
        <ul>
          <li>
            ...
            <p className="mt-8 leading-7">
              Service is the Badget application operated by Badget Labs AB
            </p>
          </li>
          <li>
            <p className="mt-8 leading-7">
        ...
        <h2>Use of Data</h2>
        <p className="mt-8 leading-7">
          Badget Labs AB uses the collected data for various purposes:
        </p>
        <ul>
        ...
        <p className="mt-8 leading-7">
          Badget's use of information received from Google APIs will adhere to
        ...
        <p className="mt-8 leading-7">
          If you are from the European Economic Area (EEA), Badget Labs AB legal
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB may process your Personal Data because:
        </p>
        <ul>
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB will retain your Personal Data only for as long as is
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB will also retain Usage Data for internal analysis
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB will take all the steps reasonably necessary to ensure
        ...
        <p className="mt-8 leading-7">
          If Badget Labs AB is involved in a merger, acquisition or asset sale,
        ...
        <p className="mt-8 leading-7">
          Under certain circumstances, Badget Labs AB may be required to
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB may disclose your Personal Data in the good faith
          belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of Badget Labs AB
          </li>
          <li>
        ...
        <p className="mt-8 leading-7">
          ...
          certain data protection rights. Badget Labs AB aims to take reasonable
        ...
        <ul>
          ...
          <li>
            <p className="mt-8 leading-7">
              ...
              right to withdraw your consent at any time where Badget Labs AB
        ...
        <ul>
          <li>By email: support@badget.ai</li>
        </ul>
      </div>
    </div>
  );
