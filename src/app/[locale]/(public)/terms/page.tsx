    ...
    <div className="m-auto my-20 max-w-[600px]">
      ...
      <div className="text-component line-height-lg v-space-md">
        ...
        <p className="mt-8 leading-7">
          ...
          your relationship with the Badget application (the "Service") operated
          by Badget Labs AB ("us", "we", or "our").
        </p>
        ...
        <p className="mt-8 leading-7">
          ...
          renew under the same conditions unless you cancel it or Badget Labs AB
          cancels it. You may cancel your Subscription through your online
          account management page or by contacting Badget Labs AB's customer
          support.
        </p>

        <p className="mt-8 leading-7">
          A valid payment method, including a credit card, is required. You must
          provide accurate and complete billing information. By submitting
          payment information, you authorize us to charge Subscription fees to
          your chosen payment method.
        </p>

        <p className="mt-8 leading-7">
          If automatic billing fails, Badget Labs AB will issue an invoice and
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB may modify Subscription fees at its sole discretion.
          Any changes will take effect at the end of the current Billing Cycle.
        </p>

        <p className="mt-8 leading-7">
          We will provide reasonable prior notice of any changes. Continued use
          of the Service after fee changes take effect constitutes your
        ...
        <p className="mt-8 leading-7">
          ...
          granted at the sole discretion of Badget Labs AB.
        </p>
        ...
        <p className="mt-8 leading-7">
          ...
          for the legality, reliability, and appropriateness of any Content you
          post.
        </p>
        ...
        <p className="mt-8 leading-7">You warrant that:</p>
        <ul className="mt-4 list-disc pl-6">
          <li className="leading-7">You own or have rights to the Content,</li>
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB does not verify the accuracy or suitability of any
        ...
        <p className="mt-8 leading-7">You may not use a username that:</p>
        <ul className="mt-4 list-disc pl-6">
          <li className="leading-7">
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB is not a financial advisor, accountant, or tax
          consultant. All content and functionality within the Service are
          provided for general informational purposes only and do not constitute
          financial, legal, or tax advice.
        </p>

        <p className="mt-8 leading-7">
          You are solely responsible for complying with all applicable financial
          and tax regulations, including local reporting obligations. We
          strongly recommend verifying all decisions and data with your local
          tax authority or a qualified professional.
        </p>

        <p className="mt-8 leading-7">
          Badget Labs AB accepts no liability for any consequences, losses, or
          penalties resulting from your use of the Service for financial or tax
          purposes.
        </p>
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB relies on third-party services (e.g., banking APIs,
          payment providers, and financial aggregators) to provide transactional
          data and related functionality. Additionally, the Service may involve
          manually inputted or user-generated data.
        </p>

        <p className="mt-8 leading-7">You acknowledge and agree that:</p>
        <ul className="mt-4 list-disc pl-6">
          <li className="leading-7">
          ...
          <li className="leading-7">
            Badget Labs AB cannot guarantee the completeness, accuracy,
          ...
          <li className="leading-7">
            Badget Labs AB shall not be liable for any loss, damage, or
        ...
        <p className="mt-8 leading-7">
          ...
          infringement, please email dmca@Badget.ai with:
        </p>
        <ul className="mt-4 list-disc pl-6">
          <li className="leading-7">A detailed description of the material,</li>
          <li className="leading-7">Identification of the copyrighted work,</li>
        ...
        <p className="mt-8 leading-7">
          ...
          Badget Labs AB and its licensors.
        </p>
        ...
        <p className="mt-8 leading-7">
          ...
          are not controlled by Badget Labs AB.
        </p>

        <p className="mt-8 leading-7">
          We assume no responsibility for third-party content, privacy policies,
          or practices. You agree that Badget Labs AB shall not be liable for
        ...
        <p className="mt-8 leading-7">
          We may terminate or suspend your account without prior notice for any
        ...
        <p className="mt-8 leading-7">
          Badget Labs AB and its affiliates, directors, employees, and suppliers
        ...
        <p className="mt-8 leading-7">We do not warrant that:</p>
        <ul className="mt-4 list-disc pl-6">
          <li className="leading-7">
        ...
        <p className="mt-8 leading-7">
          Failure to enforce any part of the Terms does not waive our rights. If
          any provision is found to be invalid, the remainder remains in effect.
        </p>

        <p className="mt-8 leading-7">
          These Terms constitute the entire agreement between you and Badget
        ...
        <p className="mt-8 leading-7">support@Badget.ai</p>
      </div>
    </div>
  );
}
